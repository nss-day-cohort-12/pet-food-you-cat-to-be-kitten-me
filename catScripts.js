...
function executeThisCodeAfterFileIsLoaded () {
	...
	var outputEl = document.getElementById("catFoodOutput");

	var petFoodData = "";
	var currentBrand;

  petFoodData += "<div class='row'>";
	for (var i = 0; i < data.cat_brands.length; i++) {  // i is index of array cat_brands
		currBrand = data.cat_brands[i];
  ...
  // i is the index of the object within the cat_brands array
...
myRequest.open("GET", "catfood.json"); //Get, post, put, delete are the four verbs used//
myRequest.send();